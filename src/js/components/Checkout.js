                    ...
                    <section className="stCheckoutWindow" onClick={(e) => this.props.closeCheckout()}>
                        <div className="stCheckoutInner" onClick={(e) => e.stopPropagation()}>
                            ...
                            <form action={action} onSubmit={(e) => {
                                ...
                                {!state.doTrial ? null : <div className="stTrialMsg">You elected the 5 day limited free trial. You card will not be charged until {theDate.setDate(theDate.getDate() + 5).toString()}. By clicking below, you agree to pay the full amount due to unlock your course subscription.</div>}
