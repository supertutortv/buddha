    ...
    return (
        <div id="stSignupThankYou" class="stSignupStep row">
            <div class="stSignupInner col s12">
                ...
                <div className="row">You will receive a payment receipt when your card is charged, either after your trial expires or very soon if you skipped the trial. You will also receive a welcome email with instructions for using the course. Or if you'd like to get started right now, just click the button below.</div>
                <div className="stFormButtons row">
