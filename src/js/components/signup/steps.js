    ...
    return (
        <div id="stSignupThankYou" class="stSignupStep row">
            <div class="stSignupInner stFormWrapper col s12">
                ...
                <div className="col s12 m6 offset-m3"><span>You will receive a payment receipt when your card is charged, either after your trial expires or very soon if you skipped the trial. You will also receive a welcome email with instructions for using the course. Or if you'd like to get started right now, just click the button below.</span></div>
                <div className="stFormButtons row">
                    <button id="stBtn_thankyou" type="submit" className="stFormButton btn waves-effect waves-light" onClick={() => <Redirect to="/dashboard" />} >Go to dashboard</button>
                </div>
            </div>
        </div>
    )
