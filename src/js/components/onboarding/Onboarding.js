						...
						<div className="stConfirmCardInner">
							<div className="reviewTable">
								...
								<div className="lineItems">
									...
									<div>
										<div>
											{shipping ? <span>Priority Shipping <em>(3-4 days)</em></span> : loc && loc !== 'US' ? <span>International eBook <em>(electronic delivery)</em></span> : <span>Standard Shipping <em>(2-3 weeks)</em></span> }
										</div>
