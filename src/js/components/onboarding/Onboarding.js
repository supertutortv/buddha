					...
					{!ship ? null : <form className="shippingForm nopad big" onChange={shipChanged} onSubmit={(e) => {
						...
						<div className="shipOptBtn">
							<div>
								...
								<span>
									<input id="priShipMedia" className="priShip" type="radio" name="priShip" value="false" required checked/>
						...
						<div className="stConfirmCardInner">
							...
							<div className="initCheckoutFinal">
								<div className="trialToggle">
									...
									<label aria-hidden="true" for="doTrial">I would like the FREE 5 day limited access trial, please!</label>
								</div>
